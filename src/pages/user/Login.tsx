 import { Mail, Lock, Eye, EyeOff, TrendingUp, FileText, DollarSign } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Invoice Manager</h1>
          <p className="text-gray-300">Track, manage, and organize your freelance finances</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <p className="text-center text-gray-300 text-sm mb-4">What you can manage:</p>
        ...
        <div className="text-center mt-6">
          <p className="text-gray-300">
            ...
            <Link to="/signup" className="text-white font-semibold hover:text-gray-200 transition-colors duration-200">
              Sign up for free
            </Link>
          </p>
        </div>
